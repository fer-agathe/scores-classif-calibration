...
Let us load the functions defined in [Chapter -@sec-real-example]:
```{r}
...
<!-- ### Appartment for Rent Classified -->

<!-- URL to the data: <https://archive.ics.uci.edu/dataset/555/apartment+for+rent+classified> -->
<!-- This is a dataset of classified for apartments for rent in USA. -->
<!-- Number of instances: 10,000 -->
<!-- Features: 21 -->

<!-- ```{r define-name-appartment} -->
<!-- name <- "appartment" -->
<!-- ``` -->

<!-- The dataset needs to be download. -->
<!-- ```{r download-appartment, eval=FALSE} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to download the data -->
...
<!-- download.file( -->
<!--   url = str_c( -->
<!--     "https://archive.ics.uci.edu/static/public/555/",  -->
...
<!-- Then, we can import the dataset: -->
<!-- ```{r import-appartment-data} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to import the data -->

<!-- # Extract ZIP file -->
<!-- unzip("data/appartment.zip", exdir = "data/appartment") -->
<!-- # Extract the 7z file -->
<!-- system("7z x data/appartment/apartments_for_rent_classified_100K.7z -odata/appartment") -->
<!-- csv_file_path <- "data/appartment/apartments_for_rent_classified_100K.csv" -->
<!-- tb_appartment <- read_csv2(csv_file_path, show_col_types = FALSE) |>  -->
<!--   select(-id, -title, -body, -price_display, -address, -time, -price_type, -currency, -amenities, -fee) -->
<!-- system("rm -rf data/appartment/") -->
<!-- ``` -->
<!-- The target variable is `sex`. Let us turn it in a $\{0,1\}$` variable. -->
<!-- ```{r tb_appartment-target} -->
<!-- tb_appartment <- tb_appartment |> -->
<!--   mutate( -->
<!--     cityname = fct_lump(cityname, prop = 0.01), -->
<!--     state = fct_lump(state, prop = 0.02), -->
<!--     source = fct_lump(source, prop = 0.01), -->
<!--     latitude = as.numeric(latitude), -->
<!--     longitude = as.numeric(longitude) -->
<!--   ) |>  -->
<!--   mutate(across(where(is.character), ~as.factor(as.numeric(as.factor(.x))))) |>  -->
<!--   mutate( -->
<!--     high_square_feet = square_feet > median(square_feet) -->
<!--   ) |>  -->
<!--   select(-square_feet) -->
<!-- tb_appartment <- na.omit(tb_appartment) -->
<!-- nrow(tb_appartment) -->
<!-- target_name <- "high_square_feet" -->
<!-- ``` -->

<!-- Let us call the `get_beta_fit()`{.R} from [Chapter -@sec-real-example] to get our priors. -->
<!-- ```{r estim-appartment, eval=FALSE} -->
<!-- priors_appartment <- get_beta_fit( -->
<!--   dataset = tb_appartment, target_name = target_name, seed = 1234 -->
<!-- ) -->
<!-- ``` -->

<!-- Let us save the results and the dataset: -->
<!-- ```{r, eval=FALSE} -->
<!-- save(priors_appartment, file = "output/real-data/priors_appartment.rda") -->
<!-- save(tb_appartment, file = "output/real-data/tb_appartment.rda") -->
<!-- ``` -->

<!-- ```{r, echo=FALSE} -->
<!-- load("output/real-data/priors_appartment.rda") -->
<!-- ``` -->


<!-- ```{r} -->
<!-- #| fig-cap: Distribution of estimated probabilities by the GAMSEL model and Beta distribution fitted to the scores of each of the three models, for the Appartment dataset. -->
<!-- #| label: fig-example-beta-appartment -->
<!-- plot_hist_scores_beta(priors_appartment, "appartment") -->
<!-- ``` -->
...
<!-- URL to the data: <https://archive.ics.uci.edu/dataset/59/letter+recognition> -->
<!-- Description: Database of character image features; try to identify the letter. -->
<!-- Number of instances: 20,000 -->
<!-- Features: 16 -->

<!-- ```{r define-name-letterecognition} -->
<!-- name <- "letterecognition" -->
<!-- ``` -->

<!-- The dataset needs to be download. -->
<!-- ```{r download-letterecognition, eval=FALSE} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to download the data -->
...
<!-- Then, we can import the dataset: -->
<!-- ```{r import-letterecognition-data} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to import the data -->
<!-- tb_letterecognition <- read_csv( -->
<!--   file = unz(str_c("data/", name, ".zip"), "letter-recognition.data"),  -->
<!--   col_names = c( -->
...
<!-- ) -->
<!-- ``` -->
<!-- The target variable is `lettr`. Let us turn create a $\{0,1\}$` variable where whe predict whether the letter is "U" or not. -->
<!-- ```{r tb_letterecognition-target} -->
<!-- tb_letterecognition <-  -->
<!--   tb_letterecognition |>  -->
<!--   mutate(across(where(is.numeric), ~as.factor(.x))) |>  -->
<!--   mutate(is_u = ifelse(lettr == "U", 1, 0)) |>  -->
<!--   select(-lettr) -->
<!-- target_name <- "is_u" -->
<!-- ``` -->

<!-- Let us call the `get_beta_fit()`{.R} from [Chapter -@sec-real-example] to get our priors. -->
<!-- ```{r estim-letterecognition, eval=FALSE} -->
<!-- priors_letterecognition <- get_beta_fit( -->
<!--   dataset = tb_letterecognition, target_name = target_name, seed = 1234 -->
<!-- ) -->
<!-- ``` -->

<!-- Let us save the results and the dataset: -->
<!-- ```{r, eval=FALSE} -->
<!-- save(priors_letterecognition, file = "output/real-data/priors_letterecognition.rda") -->
<!-- save(tb_letterecognition, file = "output/real-data/tb_letterecognition.rda") -->
<!-- ``` -->

<!-- ```{r, echo=FALSE} -->
<!-- load("output/real-data/priors_letterecognition.rda") -->
<!-- ``` -->


<!-- ```{r} -->
<!-- #| fig-cap: Distribution of estimated probabilities by the GAMSEL model and Beta distribution fitted to the scores of each of the three models, for the Letter Recognition dataset. -->
<!-- #| label: fig-example-beta-letterecognition -->
<!-- plot_hist_scores_beta(priors_letterecognition, "letterecognition") -->
<!-- ``` -->
...
<!-- URL to the data: <https://archive.ics.uci.edu/dataset/468/online+shoppers+purchasing+intention+dataset> -->
<!-- Description: Of the 12,330 sessions in the dataset, 84.5% (10,422) were negative class samples that did not end with shopping, and the rest (1908) were positive class samples ending with shopping. -->
<!-- Number of instances: 12,330 -->
<!-- Features: 17 -->

<!-- ```{r define-name-onlineshoppers} -->
<!-- name <- "onlineshoppers" -->
<!-- ``` -->

<!-- The dataset needs to be download. -->
<!-- ```{r download-onlineshoppers, eval=FALSE} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to download the data -->

<!-- if (!dir.exists("data")) dir.create("data") -->
<!-- download.file( -->
<!--   url = str_c("https://archive.ics.uci.edu/static/public/468/", -->
...
<!-- Then, we can import the dataset: -->
<!-- ```{r import-onlineshoppers-data} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to import the data -->
<!-- tb_onlineshoppers <- read_csv( -->
<!--   file = unz(str_c("data/", name, ".zip"), "online_shoppers_intention.csv"), -->
<!--   show_col_types = FALSE -->
<!-- ) -->
<!-- ``` -->
<!-- The target variable is `sex`. Let us turn it in a $\{0,1\}$` variable. -->
<!-- ```{r tb_onlineshoppers-target} -->
<!-- tb_onlineshoppers <-  -->
<!--   tb_onlineshoppers |>  -->
<!--   mutate(across(where(is.character), ~as.factor(.x))) |>  -->
<!--   mutate(across(where(is.logical), ~as.factor(.x))) |>  -->
<!--   mutate(across(all_of(c( -->
<!--     "Administrative", "OperatingSystems", "Browser", "Region" -->
<!--   )), ~as.factor(.x))) |>  -->
<!--   mutate((across(all_of(c( -->
<!--     "Informational", "SpecialDay", "TrafficType", "Informational_Duration", -->
<!--     "Administrative_Duration", "PageValues", "BounceRates", "ProductRelated_Duration", "ProductRelated", "ExitRates" -->
<!--   )), ~jitter(.x, 0.1))) -->
<!--   ) |>  -->
...
<!-- Let us call the `get_beta_fit()`{.R} from [Chapter -@sec-real-example] to get our priors. -->
<!-- ```{r estim-onlineshoppers, eval=FALSE} -->
<!-- priors_onlineshoppers <- get_beta_fit( -->
<!--   dataset = tb_onlineshoppers, target_name = target_name, seed = 1234 -->
<!-- ) -->
<!-- ``` -->

<!-- Let us save the results and the dataset: -->
<!-- ```{r, eval=FALSE} -->
<!-- save(priors_onlineshoppers, file = "output/real-data/priors_onlineshoppers.rda") -->
<!-- save(tb_onlineshoppers, file = "output/real-data/tb_onlineshoppers.rda") -->
<!-- ``` -->

<!-- ```{r, echo=FALSE} -->
<!-- load("output/real-data/priors_onlineshoppers.rda") -->
<!-- ``` -->


<!-- ```{r} -->
<!-- #| fig-cap: Distribution of estimated probabilities by the GAMSEL model and Beta distribution fitted to the scores of each of the three models, for the Online Shoppers Purchasing Intention dataset. -->
<!-- #| label: fig-example-beta-onlineshoppers -->
<!-- plot_hist_scores_beta(priors_onlineshoppers, "onlineshoppers") -->
<!-- ``` -->

<!-- ### Online News Popularity -->

<!-- URL to the data: <https://archive.ics.uci.edu/dataset/332/online+news+popularity> -->
<!-- Description: Predict the age of newspopularity from physical measurements. -->
<!-- Number of instances: 39,797 -->
<!-- Features: 58 -->

<!-- ```{r define-name-newspopularity} -->
<!-- name <- "newspopularity" -->
<!-- ``` -->

<!-- The dataset needs to be download. -->
<!-- ```{r download-newspopularity, eval=FALSE} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to download the data -->

<!-- if (!dir.exists("data")) dir.create("data") -->
<!-- download.file( -->
<!--   url = str_c("https://archive.ics.uci.edu/static/public/332/", -->
...
<!-- Then, we can import the dataset: -->
<!-- ```{r import-newspopularity-data} -->
<!-- #| code-fold: true -->
<!-- #| code-summary: Code to import the data -->
<!-- dir.create("data/newspopularity") -->
<!-- unzip("data/newspopularity.zip", exdir = "data/newspopularity") -->
<!-- tb_newspopularity <- read_csv( -->
<!--   file = str_c("data/newspopularity/OnlineNewsPopularity/", -->
<!--                "OnlineNewsPopularity.csv"),  -->
<!--   show_col_types = FALSE -->
<!-- ) -->
<!-- system("rm -rf data/newspopularity") -->
<!-- ``` -->

<!-- We define the target variable, `high_shares` as a binary variable which is equal to 1 if the number of shares is higher than the median value found in the sample, and 0 otherwise. -->

<!-- ```{r tb_newspopularity-target} -->
<!-- tb_newspopularity <-  -->
<!--   tb_newspopularity |>  -->
<!--   select(-url) |>  -->
<!--   mutate( -->
...
<!--         "weekday_is_thursday", "weekday_is_friday", "weekday_is_saturday", "is_weekend" -->
<!--       )), -->
<!--       ~as.factor(.x) -->
<!--     ), -->
<!--     high_shares = ifelse(shares > median(shares), yes = 1, no = 0), -->
<!--     across(all_of(c( -->
<!--       "n_non_stop_words", "num_keywords", "kw_min_min", "n_tokens_title", "kw_max_max", "min_positive_polarity", "max_positive_polarity", "max_negative_polarity", "num_self_hrefs", "num_imgs", "num_hrefs" -->
<!--       )), ~jitter(.x, factor = 0.01)) -->
<!--   ) |>  -->
<!--   select( -->
<!--     -shares, -weekday_is_sunday, -is_weekend, -global_rate_positive_words, -->
<!--     -global_rate_negative_words, -rate_positive_words, -abs_title_subjectivity, -->
<!--     -abs_title_sentiment_polarity -->
<!--   ) -->
<!-- target_name <- "high_shares" -->
<!-- ``` -->

<!-- Let us call the `get_beta_fit()`{.R} from [Chapter -@sec-real-example] to get our priors. -->
<!-- ```{r estim-newspopularity, eval=FALSE} -->
<!-- priors_newspopularity <- get_beta_fit( -->
<!--   dataset = tb_newspopularity, target_name = target_name, seed = 1234 -->
<!-- ) -->
<!-- ``` -->

<!-- Let us save the results and the dataset: -->
<!-- ```{r, eval=FALSE} -->
<!-- save(priors_newspopularity, file = "output/real-data/priors_newspopularity.rda") -->
<!-- save(tb_newspopularity, file = "output/real-data/tb_newspopularity.rda") -->
<!-- ``` -->

<!-- ```{r, echo=FALSE} -->
<!-- load("output/real-data/priors_newspopularity.rda") -->
<!-- ``` -->


<!-- ```{r} -->
<!-- #| fig-cap: Distribution of estimated probabilities by the GAMSEL model and Beta distribution fitted to the scores of each of the three models, for the Online News Popularity dataset. -->
<!-- #| label: fig-example-beta-newspopularity -->
<!-- plot_hist_scores_beta(priors_newspopularity, "newspopularity") -->
<!-- ``` -->
